...
public class NotebookPresenter {    // создание презентора для работы с записями
    private Notebook model;     // поля класса
    private NotebookView view;

    public NotebookPresenter(Notebook model, NotebookView view) {   // метод конструктор презентора 
        this.model = model;
        this.view = view;
    }
    // ниже интерфейс для работы
    public void addNote() {
